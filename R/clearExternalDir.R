...
#'
#' Clear the external installation directory by removing old Miniconda instances or environments
...
#'
#' @return 
#' For \code{clearExternalDir}, all Miniconda instances (and associated environments) of the same Bioconductor release as the current \pkg{basilisk} installation are destroyed.
#'
#' The same applies for \code{clearObsoleteDir} except that the Miniconda instance generated by the latest \pkg{basilisk} installation is retained.
#'
#' @author Aaron Lun
#'
#' @seealso
...
#'
#' @seealso
#' \code{\link{installMiniconda}}, for the motivation behind this function.
#'
#' @examples
